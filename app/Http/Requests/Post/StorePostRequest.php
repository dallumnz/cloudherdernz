 ...
 * Store Post Request
 *
 * Validates data for creating a new post. Handles validation
 * for all post types (image, video, audio) with type-specific
 * field requirements.
 */
class StorePostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'caption' => ['nullable', 'string', 'required_if:post_type,image'],
            'gallery_settings' => ['nullable', 'json'],
            'video_url' => ['nullable', 'string', 'required_if:post_type,video'],
            'thumbnail_url' => ['nullable', 'string'],
            'duration_seconds' => ['nullable', 'integer'],
            'provider' => ['nullable', 'string', 'in:youtube,vimeo,self'],
            'episode_number' => ['nullable', 'integer'],
            'audio_url' => ['nullable', 'string', 'required_if:post_type,audio'],
    ...
    public function messages(): array
    {
        return [
            ...
            'caption.required_if' => 'Please add a caption for this image post.',
            'caption.string' => 'The caption must be text.',
            'gallery_settings.json' => 'Gallery settings must be valid JSON format.',
            'video_url.required_if' => 'Please provide a video URL for this video post.',
            ...
            'audio_url.required_if' => 'Please provide an audio URL for this audio post.',

...
return [
    ...
    'geolocation' => [
        ...
        'provider' => env('REQUEST_ANALYTICS_GEO_PROVIDER', 'maxmind'),
        'api_key' => env('REQUEST_ANALYTICS_GEO_API_KEY'),

        // MaxMind specific configuration
        'maxmind' => [
            'type' => env('REQUEST_ANALYTICS_MAXMIND_TYPE', 'database'),
            'user_id' => env('REQUEST_ANALYTICS_MAXMIND_USER_ID'),
            'license_key' => env('REQUEST_ANALYTICS_MAXMIND_LICENSE_KEY'),
            'database_path' => env('REQUEST_ANALYTICS_MAXMIND_DB_PATH', database_path('GeoLite2-Country.mmdb')),
        ],
    ],

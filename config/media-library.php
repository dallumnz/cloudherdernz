...
use Spatie\MediaLibrary\Pro\Models\TemporaryUpload;
use Spatie\MediaLibrary\ResponsiveImages\ImageGenerator\DefaultImageGenerator;
...
return [
    ...
    'responsive_images' => [
         ...
         */
        'image_generator' => DefaultImageGenerator::class,

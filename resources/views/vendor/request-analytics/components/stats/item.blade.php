...
<div class="flex items-center justify-between py-2 px-1 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-150">
    ...
    <div class="flex items-center gap-3 flex-shrink-0">
        <span class="font-semibold text-sm text-gray-900 dark:text-white">{{ $count }}</span>

    ...
    <div class="space-y-6">
        ...
        <flux:card>
            ...
            <div class="flex flex-wrap gap-3">
                @can('create posts')
                    <flux:button href="{{ route('admin.posts') }}" variant="primary" icon="plus">
                        Manage Posts
                    </flux:button>
                @endcan
                ...
                @can('view media')
                    <flux:button href="{{ route('admin.media.index') }}" variant="outline" icon="photo">
                        Media Library
                    </flux:button>
                @endcan

                @can('edit roles')
                    <flux:button href="{{ route('roles.manage') }}" variant="outline" icon="users">
                        Manage Roles
                    </flux:button>
                @endcan
            </div>
